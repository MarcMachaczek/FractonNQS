...
np.savetxt(f"{BENCHMARK_PATH}/custom_operator_performance.txt",
           np.asarray([custom_toric_times, netket_toric_times, custom_checkerboard_times, netket_checkerboard_times]).T,
           header="custom toric, netket toric, custom checkerboard, netket checkerboard")